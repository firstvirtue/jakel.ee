...
export default function Post(
  ...
  const currentProject = getProjectInformation('vyvydstudio')
  const prevProject = getProjectInformation('galleria')
  const nextProject = getProjectInformation('samsungcnt')
