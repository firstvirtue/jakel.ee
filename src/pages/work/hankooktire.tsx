...
export default function Post() {
  ...
  const currentProject = projectData.find(x => x.id === 'hankooktire')
  const prevProject = projectData.find(x => x.id === 'hanwhadefense')
  const nextProject = projectData.find(x => x.id === 'iconic20')
