...
export default function About(
  ...
  return (
    ...
    <div className="max-w-3xl mr-auto ml-auto mt-64">
      ...
      <div>{t('common:about.award-010')} - <span css={awardClient}>{t('common:about.award-011')}</span></div>
      <div>{t('common:about.award-020')} - <span css={awardClient}>{t('common:about.award-021')}</span></div>
      <div>{t('common:about.award-030')} - <span css={awardClient}>{t('common:about.award-031')}</span></div>
      <div>{t('common:about.award-040')} - <span css={awardClient}>{t('common:about.award-041')}</span></div>
      <div>{t('common:about.award-050')} - <span css={awardClient}>{t('common:about.award-051')}</span></div>
      <div>{t('common:about.award-060')} - <span css={awardClient}>{t('common:about.award-061')}</span></div>
      <div>{t('common:about.award-070')} - <span css={awardClient}>{t('common:about.award-071')}</span></div>
      <div>{t('common:about.award-080')} - <span css={awardClient}>{t('common:about.award-081')}</span></div>
      <div>{t('common:about.award-090')} - <span css={awardClient}>{t('common:about.award-091')}</span></div>
      <div>{t('common:about.award-100')} - <span css={awardClient}>{t('common:about.award-101')}</span></div>
      <div>{t('common:about.award-110')} - <span css={awardClient}>{t('common:about.award-111')}</span></div>
      <div>{t('common:about.award-120')} - <span css={awardClient}>{t('common:about.award-121')}</span></div>
      <div>{t('common:about.award-130')} - <span css={awardClient}>{t('common:about.award-131')}</span></div>
    </div>
    </>
  )
}
