export default function About() {
  return (
    ...
    <div className="max-w-3xl mr-auto ml-auto mt-64">
      ...
      <p>
        이 흥미로운 기술 세계에서 때로는 생존을 위해 과감히 가진 것을 버리고 최신 기술 스택을 선택해야 할 때가 있었습니다.
      </p>
      <p>
      ...
      <p>
        스크린에 컴포넌트를 올리고 이를 여러 방향으로 연결시키고 그 상태를 관리하고 고수준 애니메이션이 필요하다면 렌더링 루프로 처리하는 등 이 모든 일이 같으며, 라이브러리는 이를 보다 효율적으로 만들어 주는 도구에 불과함을 말입니다.
      </p>
      <p>
      ...
      <p>데이터베이스 테이블을 설계하고 API를 만들어 서비스하며, 쌓여진 데이터를 통계 쿼리로 분석한 실무 경험은 웹의 전반적인 구조와 흐름을 파악하게 한 저의 훌륭한 자산입니다. </p>
      <br />
      <p>
